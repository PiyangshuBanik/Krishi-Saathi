document.addEventListener('DOMContentLoaded', () => {
  ...
  const API_KEY = 'AIzaSyCh-1osIi4tMAAM0pudn8CpegWKg1wMxMU'; // get api key from https://ai.google.dev/
  ...
  function displayMessage(messageContent, sender) {
    ...
    const name = sender === 'user' ? 'You' : 'KrishiBot';
  ...
  const showTyping = () => {
    ...
    typing.innerHTML = `<div>KrishiBot is typing</div><span></span><span></span><span></span>`;
  ...
  setTimeout(() => {
    displayMessage('Hello! 🌱 I\'m KrishiBot, your agricultural assistant. I can help you with farming questions, crop management, soil health, pest control, and more. How can I assist you today?', 'bot');
  }, 500);
